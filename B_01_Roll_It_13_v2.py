...
# Program starts there (with heading)
print()
print("🎲🎲 Roll it 13 🎲🎲")
print()

# Display instructions if use wants to see them.
...
while user_score < target_score and comp_score < target_score:
    ...
    # loop (while both users / computer have <= 13 points)...
    ...
    # currently does not include double points!
        ...
        # Double user points if they are eligble
        if double_points == "yes":
            user_points *= 2
